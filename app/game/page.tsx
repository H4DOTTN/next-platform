...
export default function Page({ shortName = '' }: { shortName: string }) {
    ...
    <>
            ...
            <div>
              ...
              >
                <StylelessButton
                  ...
                  onClick={() => navigate.push('/game/' + game.short_name)}
                >
                  <Svg.Close />
                </StylelessButton>
              </div>
      ...
      {GAMES.length > 1 && (
        <Section>
          ...
          >
            {GAMES.map((game: any) => (
              <Link key={game.short_name} href={`/game/${game.short_name}`}>
                <Card
                  width={150}
                  height={play ? 50 : 200}
          ...
          <Section>
            ...
            >
              <Button
                ...
                pulse
                onClick={() =>
                  navigate.push('/game/' + game.short_name + '/play')
                }
              >
